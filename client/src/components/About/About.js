      ...
      <div className="About">
        ...
        <div className="About__Description">
          ...
          <p>
            ...
            may create and manage multiple leaderboards via the private key
            given after Leaderboard creation. This private key allows users to
            reaccess already created leaderboards with full privileges. In
            addition to this, the creator of the leaderboard can share the
